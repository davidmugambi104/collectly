...
Updated: 2026-09-06 09:58 EAT (06:58 UTC) by `collectly-launch-executor` cron (Sun, daily)

> **HEADLINE (2026-09-06 09:58 EAT):** **🚨 GATE PULLBACK DAY 4 — `pullback/cap=30`, bounce rate now 13.38% (21/157)** —
> pipeline THROTTLED. Fresh snapshot (Sep 6 06:58 UTC):
> **157 sends, 21 bounces, 13.38% bounce rate** — DOWN from 16.98% on Sep 5.
> Bounce rate DECREASING because new sends (106→157) are entering the 7d window
> faster than bounces (18→21, only +3 new). Denominator growing helps.
> 3 new bounces appeared since Sep 5 snapshot. Bounces will start aging out ~Sep 9.
> Seed-inbox: 6/155 total, 148 awaiting folder report. CRM: **257 rows** (up from 209),
> **1 malformed** (Lana recovery only), 227 prospect states emitted, 17 dup-touch flags.
> Experiments: **A=61/1/1.64% — KILLED (weight=0.0).** **B=60/0/0%, C=60/0/0%, D=60/0/0%** —
> **ALL B/C/D PAST KILL THRESHOLD (50+ sends, 0% reply).** 0/180 combined for B/C/D. 1 reply in 241 lifetime sends.
> Rate: 18 sends on Sep 6. 1 new git commit: `cb780a5` (checklist refresh). **46 days post-launch. Operational, not P0.**
>
