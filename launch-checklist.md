...
Updated: 2026-09-05 14:01 EAT (11:01 UTC) by `collectly-launch-executor` cron (Sat, daily)

> **HEADLINE (2026-09-05 14:01 EAT):** **🚨 GATE PULLBACK DAY 3 — `pullback/cap=30`, bounce rate WORSENED to 16.98% (18/106)** —
> pipeline THROTTLED. Fresh snapshot (Sep 5 11:01 UTC):
> **106 sends, 18 bounces, 16.98% bounce rate** — UP from 13.43% on Sep 4.
> Bounce rate INCREASING because sends aging out of 7d window faster than bounces
> (134→106 sends, bounces stable at 18). All 18 bounces from Sep 2 OSM/Apify batch + 2 from Aug 31.
> Bounces will start aging out ~Sep 9 (7d after Sep 2 sends). Until then, rate will keep climbing.
> Seed-inbox: 6/151 total, 144 awaiting folder report. CRM: **209 rows** (stable),
> **1 malformed** (Lana recovery only), 192 prospect states emitted, 17 dup-touch flags.
> Experiments: **A=51/1/1.96% — KILLED (weight=0.0).** **B=48/0/0%, C=46/0/0%, D=48/0/0%** —
> **B and D only 2 sends from kill threshold (50).** 0/142 combined for B/C/D. 1 reply in 193 lifetime sends.
> Rate: 6 sends on Sep 3. No new git commits since `ccebaa4`. **45 days post-launch. Operational, not P0.**
>
...
- [ ] Seed-inbox deliverability test: 4/4 pass — **OPEN** (6/74 Primary confirmed, 68 awaiting folder report; gate is `conditional_pass` → `allow` based on live bounce rate dropping below 5%)
- [ ] Resend sending at policy cap with healthy bounce/spam rates — **PULLBACK** (gate `pullback/cap=30` since Sep 3; live 7d bounce 16.98% (18/106); 18 bounces from Sep 2 OSM/Apify batch + 2 from Aug 31; bounces age out ~Sep 9; pipeline throttled)
