# Collectly Dependency Vulnerability Scan — 2026-08-31

**Run by:** `collectly-dependency-vulnerability-scanner` (weekly cron)
**Repo:** `/home/user/.openclaw/workspace/collectly`
**Time:** 2026-08-31 22:15 EAT (19:15 UTC)

## Summary

| Severity | 2026-08-04 (baseline) | 2026-08-10 | 2026-08-18 | 2026-08-23 | 2026-08-24 | 2026-08-31 (this run) | Δ vs last run |
|---|---|---|---|---|---|---|---|
| Critical | 1 | 1 | 1 | 1 | 1 | **1** | 0 |
| High     | 23 | 24 | 27 | 27 | 27 | **27** | 0 |
| Moderate | 18 | 19 | 19 | 19 | 19 | **19** | 0 |
| Low      | 6 | 6 | 6 | 6 | 6 | **6** | 0 |
| **Total**| **48** | **50** | **53** | **53** | **53** | **53** | **0** |
...
The vulnerability surface has now been stable for **13 consecutive days** (since 2026-08-18). The +3 high growth observed on 2026-08-18 has not continued, but nothing has been remediated either — the same 53 advisories persist. This is the **third consecutive zero-delta run**. The non-breaking patch wave and breaking upgrades recommended since 2026-08-10 remain unactioned.
...
Same set as 2026-08-24. Key packages:
...
Same set as 2026-08-24: `ai`, `@ai-sdk/*` family, `@esbuild-kit/*`, `@vercel/*` family (elysia, fastify, h3, hono, koa, nestjs, node, python, redwood, remix-builder, static-build, backends, express, hydrogen, rust), `ajv`, `dompurify`, `esbuild`, `jsondiffpatch`, `lazy-js-utils`, `smol-toml`, `tsup`.
...
Third consecutive zero-delta run. Advisory surface stable for 13 days.
...
_Previous report: `security/dependency-audit-2026-08-24.md`_