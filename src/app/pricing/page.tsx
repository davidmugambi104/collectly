    ...
    <div className="min-h-screen">
      ...
      <section className="container-page pb-20">
            ...
            return (
              <div key={k} className={`card-lg relative ${p.popular ? 'ring-2 ring-brand-500' : ''}`}>
                ...
                <div className="mt-1 text-sm text-ink-600">
                  {k === 'starter' && 'For solo operators and <$1M revenue'}
                  {k === 'growth' && 'For $1M–$5M revenue businesses'}
                  {k === 'scale' && 'For $5M–$20M revenue companies'}
                </div>
        ...
        <div className="mt-10 max-w-2xl mx-auto text-center">
          <p className="text-sm text-ink-600">Need 50+ seats, custom integrations, or a private cloud deployment? <Link href="/contact" className="link">Talk to sales</Link> for our Enterprise plan.</p>
        </div>
      </section>
