    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 grid lg:grid-cols-2">
        <div className="hidden lg:flex flex-col justify-between p-12 bg-ink-950 text-white">
          <div className="flex items-center gap-2.5"><Logo className="h-7 w-7 text-white" /> <span className="text-lg font-display font-bold">Mugavi</span></div>
          <div>
          ...
          <p className="text-xs text-ink-500">© 2026 Mugavi, Inc.</p>
        </div>
