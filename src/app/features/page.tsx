...
const FEATURES = [
  { icon: Bot, color: 'text-brand-600', bg: 'bg-brand-50', title: 'AI dunning engine', body: 'Tone-aware email and SMS reminders, written by GPT-4o, optimized for probability of payment. Pause on reply. Pause on payment. Fully editable before send.', bullets: ['Friendly → Firm → Final tones', 'Per-customer timing rules', 'GPT-4o written, regex-customizable', 'Auto-pause on reply or payment', 'A/B test subject lines'] },
