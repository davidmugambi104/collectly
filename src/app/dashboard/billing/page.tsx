...
import { createCheckoutSession, createCustomerPortal } from '@/lib/billing';
...
export default async function BillingPage({ searchParams }: { searchParams: Promise<{ upgraded?: string; cancelled?: string }> }) {
